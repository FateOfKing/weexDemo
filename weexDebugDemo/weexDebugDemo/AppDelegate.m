...
//  weexDebugDemo
//
//  Created by WYC on 2018/12/26.
//  Copyright © 2018 WYC. All rights reserved.
//
...
- (void)atAddPlugin {
    ...
    [[ATManager shareInstance] addSubPluginWithParentId:@"weex" andSubId:@"logger" andName:@"scan" andIconName:@"log" andEntry:@"WXATScanPlugin" andArgs:@[@""]];
